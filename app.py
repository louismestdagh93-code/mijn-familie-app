...
if not st.session_state.logged_in:
    ...
    with st.container():
        ...
        with col2:
            with st.form("login"):
                # HIER IS DE AANPASSING: Tekstkleur naar zwart geforceerd
                st.markdown("<p style='color: #000000 !important; font-weight: bold; margin-bottom: 0px;'>Familienaam</p>", unsafe_allow_html=True)
                fid = st.text_input("Naam", label_visibility="collapsed")
                
                st.markdown("<p style='color: #000000 !important; font-weight: bold; margin-bottom: 0px; margin-top: 10px;'>Toegangscode</p>", unsafe_allow_html=True)
